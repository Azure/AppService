...
This upgrade was likely an un-planned maintenance event, either a hotfix or critical security patch. Az Microsft commits to ensuring security of resources, we may not always have 7 days lead time when pushing an update to address these concerns.
