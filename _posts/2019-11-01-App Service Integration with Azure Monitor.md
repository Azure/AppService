...
| AppServiceAntivirusScanAuditLogs | Yes | Yes | Yes | Yes | [Anti-virus scan logs]({{site.baseurl}}/2020/12/09/AzMon-AppServiceAntiVirusScanLogs.html); only available for Premium tier | 
